  ...
  return (
    <header className="h-14 border-b border-sidebar-border bg-sidebar flex items-center justify-between px-4">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* User dropdown */}
        <Popover>
          <PopoverTrigger className="flex items-center gap-2 outline-none focus:outline-none cursor-pointer">
            {user?.image ? (
              <img src={user.image} alt="" className="size-8 ring-1 ring-border" />
            ) : (
              <div className="size-8 bg-muted flex items-center justify-center text-muted-foreground text-sm font-medium">
          ...
          <PopoverContent align="end" className="w-48 p-1">
            ...
            <button
              type="button"
              onClick={cycleTheme}
              className="flex items-center gap-2 px-2 py-1.5 text-sm rounded hover:bg-accent hover:text-accent-foreground transition-instant w-full text-left"
            >
              {themeIcon[theme]}
