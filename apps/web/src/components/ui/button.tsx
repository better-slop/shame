  ...
  "focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 rounded-lg border border-transparent bg-clip-padding text-sm font-medium focus-visible:ring-[3px] aria-invalid:ring-[3px] [&_svg:not([class*='size-'])]:size-4 inline-flex items-center justify-center whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none group/button select-none",
  {
    variants: {
      variant: {
        ...
        medieval:
          "relative bg-shame-blood border-2 border-shame-gold rounded-[2px] text-shame-parchment font-bold tracking-[0.1em] uppercase shadow-[0_15px_40px_-8px_var(--shame-gold)] [text-shadow:0_1px_0_rgba(0,0,0,0.3),0_1px_1px_rgba(0,0,0,0.2)] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:border-y-[8px] before:border-l-[8px] before:border-y-transparent before:border-l-shame-gold before:opacity-0 before:transition-opacity after:absolute after:right-0 after:top-1/2 after:-translate-y-1/2 after:border-y-[8px] after:border-r-[8px] after:border-y-transparent after:border-r-shame-gold after:opacity-0 after:transition-opacity hover:before:opacity-100 hover:after:opacity-100 focus-visible:before:opacity-100 focus-visible:after:opacity-100",
      },
      size: {
        default:
