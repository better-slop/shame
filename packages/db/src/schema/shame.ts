...
export const shameReport = sqliteTable(
  "shame_report",
  {
    ...
    repoContributors: integer("repo_contributors"),
    reporterIsMaintainer: integer("reporter_is_maintainer", { mode: "boolean" }).default(false),
    actorCommitCount: integer("actor_commit_count"),
