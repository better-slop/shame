CREATE TABLE `github_installation` (
	...
	`installed_by_account_id` integer,
...
CREATE INDEX `github_installation_installed_by_user_idx` ON `github_installation` (`installed_by_user_id`);--> statement-breakpoint
CREATE INDEX `github_installation_installed_by_account_idx` ON `github_installation` (`installed_by_account_id`);--> statement-breakpoint
CREATE INDEX `github_installation_installed_by_login_idx` ON `github_installation` (`installed_by_login`);--> statement-breakpoint
